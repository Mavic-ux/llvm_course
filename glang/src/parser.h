...
/**
 ** \file /home/aznaur/git/llvm_course/glang/src/parser.h
...
#line 6 "/home/aznaur/git/llvm_course/glang/src/parser.y"
...
#line 55 "/home/aznaur/git/llvm_course/glang/src/parser.h"
...
namespace yy {
#line 189 "/home/aznaur/git/llvm_course/glang/src/parser.h"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // funcSign
      char dummy2[sizeof (std::shared_ptr<glang::FuncDeclare>)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<glang::FuncDeclare>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<glang::FuncDeclare>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yytype)
    {
      ...
      case 41: // funcSign
        value.template destroy< std::shared_ptr<glang::FuncDeclare> > ();
        break;
...
#line 1591 "/home/aznaur/git/llvm_course/glang/src/parser.h"
